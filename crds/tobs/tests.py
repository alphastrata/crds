...
class Test_00_Selectors(TobsTestCase):
    ...
    def test_use_after_nominal(self):
        self._selector_testcase(
            "USE_AFTER", "2005-12-20 12:00:00", "o9f15549j_bia.fits"
        )

    def test_use_after_tuple(self):
        self._selector_testcase(
            "USE_AFTER", "2004-04-25 21:31:01", ("foo_bia.fits", "bar_bia.fits")
        )
    ...
    def test_use_after_dict(self):
        self._selector_testcase(
            "USE_AFTER",
            "2004-04-25 21:31:02",
            {"foo": "foo_bia1.fits", "bar": "bar_bia2.fits"},
        )

    def test_use_after_missing_parameter(self):
        header = {"TEST_CASE": "USE_AFTER"}  # no PARAMETER
        bestref = self.rmap.get_best_ref(header)
        assert bestref.startswith(
            "NOT FOUND UseAfter required lookup parameter 'PARAMETER' is undefined."
        )
    ...
    def test_bracket1(self):
        self._selector_testcase(
            "BRACKET", "1.25", ("cref_flatfield_120.fits", "cref_flatfield_124.fits")
        )

    def test_bracket2(self):
        self._selector_testcase(
            "BRACKET", "1.2", ("cref_flatfield_120.fits", "cref_flatfield_120.fits")
        )

    def test_bracket3(self):
        self._selector_testcase(
            "BRACKET", "1.5", ("cref_flatfield_124.fits", "cref_flatfield_124.fits")
        )

    def test_bracket4(self):
        self._selector_testcase(
            "BRACKET", "5.0", ("cref_flatfield_137.fits", "cref_flatfield_137.fits")
        )

    def test_bracket5(self):
        self._selector_testcase(
            "BRACKET", "1.0", ("cref_flatfield_120.fits", "cref_flatfield_120.fits")
        )

    def test_bracket6(self):
        self._selector_testcase(
            "BRACKET", "6.0", ("cref_flatfield_137.fits", "cref_flatfield_137.fits")
        )

    def test_geometrically_nearest1(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "1.0", "cref_flatfield_120.fits"
        )

    def test_geometrically_nearest2(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "1.2", "cref_flatfield_120.fits"
        )

    def test_geometrically_nearest3(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "1.25", "cref_flatfield_120.fits"
        )

    def test_geometrically_nearest4(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "1.4", "cref_flatfield_124.fits"
        )

    def test_geometrically_nearest5(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "3.25", "cref_flatfield_124.fits"
        )

    def test_geometrically_nearest6(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "3.26", "cref_flatfield_137.fits"
        )

    def test_geometrically_nearest7(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "5.0", "cref_flatfield_137.fits"
        )

    def test_geometrically_nearest8(self):
        self._selector_testcase(
            "GEOMETRICALLY_NEAREST", "5.1", "cref_flatfield_137.fits"
        )
...
class Test_01_Insert(TobsTestCase):
    ...
    def terminal_insert(self, selector_name, param, value):
        ...
        assert diffs[0][3] == "added terminal " + repr(
            value
        ), "diff is not an addition " + repr(diffs[0])
...
class RecursiveModify:
    ...
    def test_0_recursive_modify_rmap(self):  # , header, value, classes):
        ...
        r = rmap.ReferenceMapping.from_string(
            self.rmap_str, "./test.rmap", ignore_checksum=True
        )
    ...
    def test_1_recursive_use_rmap(self):
        ...
        assert (
            result == self.expected_lookup_result
